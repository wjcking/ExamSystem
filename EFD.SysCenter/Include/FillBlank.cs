...
{
    public partial class FillBlank : ControlBase
    {
        public FillBlank()
        {
            InitializeComponent();
            drpMainSubject.BindMainSubject(ConstInfo.QuestionType.Fill);
        ...
        public override void ButtonClick(object sender, System.EventArgs e)
        {
            ...
            {
                case "btnAddSubject":
                    MainSubjectBoard msb = new MainSubjectBoard(ConstInfo.QuestionType.Fill);
                    msb.ShowDialog();
